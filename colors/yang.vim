...
let s:palette.white = [254, '#cdcdcd' ]
let s:palette.gray15 = [253, '#c0d0d0']
...
call s:hi('Cursor', [], s:palette.gray15, '')
...
call s:hi('StatusLine', s:palette.gray12, s:palette.gray13, 'none')
call s:hi('StatusLineNC', s:palette.gray14, s:palette.gray15, 'none')
